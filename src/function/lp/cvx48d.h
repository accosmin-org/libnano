...
public:
    ...
    /// \brief constructor
    ///
    explicit linear_program_cvx48d_eq_t(tensor_size_t dims = 10, uint64_t seed = 42);
...
public:
    ...
    /// \brief constructor
    ///
    explicit linear_program_cvx48d_ineq_t(tensor_size_t dims = 10, uint64_t seed = 42);
