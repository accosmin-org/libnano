...
public:
    ...
    /// \brief constructor
    ///
    explicit linear_program_cvx48e_eq_t(tensor_size_t dims = 10, uint64_t seed = 42, scalar_t alpha = 0.0);
...
public:
    ...
    /// \brief constructor
    ///
    explicit linear_program_cvx48e_ineq_t(tensor_size_t dims = 10, uint64_t seed = 42, scalar_t alpha = 1e-6);
