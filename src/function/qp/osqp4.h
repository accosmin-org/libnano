...
///          x >= 0.
///
class NANO_PUBLIC quadratic_program_osqp4_t final : public quadratic_program_t
{
public:
    ///
    /// \brief constructor
    ///
    explicit quadratic_program_osqp4_t(tensor_size_t dims = 10, uint64_t seed = 42, scalar_t factors = 0.5,
                                       scalar_t gamma = 1.0);
