...
///
class NANO_PUBLIC quadratic_program_osqp2_t final : public quadratic_program_t
{
public:
    ///
    /// \brief constructor
    ///
    explicit quadratic_program_osqp2_t(tensor_size_t dims = 10, uint64_t seed = 42, scalar_t neqs = 0.5,
                                       scalar_t alpha = 1e-2);
