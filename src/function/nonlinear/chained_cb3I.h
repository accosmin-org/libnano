...
{
///
/// \brief convex non-smooth test function: chained CB3 I.
///
/// see "New limited memory bundle method for large-scale nonsmooth optimization", by Haarala, Miettinen, Makela, 2004
///
class NANO_PUBLIC function_chained_cb3I_t final : public function_t
{
public:
    ///
    /// \brief constructor
    ///
    explicit function_chained_cb3I_t(tensor_size_t dims = 10);
