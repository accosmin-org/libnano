...
class NANO_PUBLIC lasso_function_t final : public linear_model_t<tloss>
{
public:
    ///
    /// \brief constructor
    ///
    explicit lasso_function_t(tensor_size_t dims = 10, uint64_t seed = 42, scalar_t sratio = 10.0,
