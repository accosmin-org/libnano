...
function_factory_t& benchmark_function_t::all()
{
    ...
    std::call_once(flag, [] ()
    {
        ...
        manager.add<function_enet_mse_t>("mse+ridge", "mean squared error with ridge-like regularization", 10, 1.0, 0.0);
        manager.add<function_enet_mse_t>("mse+lasso", "mean squared error with lasso-like regularization", 10, 0.0, 1.0);
        manager.add<function_enet_mse_t>("mse+elasticnet", "mean squared error with elastic net-like regularization", 10, 1.0, 1.0);
        manager.add<function_enet_mae_t>("mae+ridge", "mean squared error with ridge-like regularization", 10, 1.0, 0.0);
        manager.add<function_enet_mae_t>("mae+lasso", "mean squared error with lasso-like regularization", 10, 0.0, 1.0);
