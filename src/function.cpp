...
factory_t<function_t>& function_t::all()
{
    ...
    const auto  op      = []()
    {
        ...
        manager.add<function_enet_mse_t>("mean squared error with lasso-like regularization", 10, 1e+3, 0.0);
        ...
        manager.add<function_enet_mse_t>("mean squared error with elastic net-like regularization", 10, 1e+3, 1e+2);
        manager.add<function_enet_mse_t>("mean squared error with elastic net-like regularization", 10, 1e+6, 1e+4);
