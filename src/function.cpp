...
bool function_t::constrain_range(const scalar_t min, const scalar_t max, const tensor_size_t dimension)
{
...
bool function_t::constrain_range(const scalar_t min, const scalar_t max)
{
    if (min < max)
    {
...
bool function_t::constrain_range(const vector_t& min, const vector_t& max)
{
...
bool function_t::constrain_less(const scalar_t max)
{
    for (tensor_size_t i = 0, size = this->size(); i < size; ++i)
    {
        m_constraints.emplace_back(constraint::maximum_t{max(i), i});
...
bool function_t::constrain_less(const scalar_t max, const tensor_size_t dimension)
{
...
bool function_t::constrain_less(const vector_t& max)
{
    if (max.size() == size())
    {
        for (tensor_size_t i = 0, size = this->size(); i < size; ++i)
...
bool function_t::constrain_greater(const scalar_t min)
{
    for (tensor_size_t i = 0, size = this->size(); i < size; ++i)
    {
        m_constraints.emplace_back(constraint::minimum_t{min, i});
...
bool function_t::constrain_greater(const scalar_t min, const tensor_size_t dimension)
{
    if (dimension >= 0 && dimension < size())
    {
        m_constraints.emplace_back(constraint::minimum_t{min, dimension});
...
bool function_t::constrain_greater(const vector_t& min)
{
    if (min.size() == size())
    {
        for (tensor_size_t i = 0, size = this->size(); i < size; ++i)
