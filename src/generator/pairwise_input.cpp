...
{
    return make_pairwise(select_sclass(datasource(), original_features1()),
                         select_sclass(datasource(), original_features2()));
}

feature_mapping_t pairwise_input_sclass_mclass_t::do_fit()
{
    return make_pairwise(select_sclass(datasource(), original_features1()),
                         select_mclass(datasource(), original_features2()));
}

feature_mapping_t pairwise_input_sclass_scalar_t::do_fit()
{
    return make_pairwise(select_sclass(datasource(), original_features1()),
                         select_scalar(datasource(), original_features2()));
}

feature_mapping_t pairwise_input_sclass_struct_t::do_fit()
{
    return make_pairwise(select_sclass(datasource(), original_features1()),
                         select_struct(datasource(), original_features2()));
}

feature_mapping_t pairwise_input_mclass_sclass_t::do_fit()
{
    return make_pairwise(select_mclass(datasource(), original_features1()),
                         select_sclass(datasource(), original_features2()));
}
...
{
    return make_pairwise(select_scalar(datasource(), original_features1()),
                         select_sclass(datasource(), original_features2()));
}
...
{
    return make_pairwise(select_struct(datasource(), original_features1()),
                         select_sclass(datasource(), original_features2()));
}
