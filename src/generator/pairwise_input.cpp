...
{
    return make_pairwise(
        select_sclass(dataset(), original_features1()),
...
{
    return make_pairwise(
        select_mclass(dataset(), original_features1()),
        select_sclass(dataset(), original_features2()));
}
...
{
    return make_pairwise(
        select_scalar(dataset(), original_features1()),
        select_sclass(dataset(), original_features2()));
}
...
{
    return make_pairwise(
        select_struct(dataset(), original_features1()),
        select_sclass(dataset(), original_features2()));
}
