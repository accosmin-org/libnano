...
[[maybe_unused]] inline std::vector<vector_t> make_random_x0s(const function_t& function, const scalar_t scale = 1.0)
{
    ...
    // bug: fletcher and lemarechal line-searches fail here
    if (function.name() == "mse+ridge[1e+06][4D]")
    {
        append(-0.0329392846903499015, 0.7837279637135796673, 0.0283170213872347976, -0.7715193264428921172);
        append(0.2628376088010133671, -0.7277449318306842274, 0.0035735592393071336, -0.2950485595924765558);
        append(-0.8039887789345949720, -0.3330868887754711016, -0.8234333969112868079, -0.1419066261673752605);
        append(-0.2996438040932120073, 0.2546643276714095627, 0.7452779549138219828, -0.4323168408835814658);
        append(0.3252463727677998850, -0.8351261889108396730, 0.2575044544128530788, 0.3666926807402199895);
    }
