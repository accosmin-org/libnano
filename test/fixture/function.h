...
[[maybe_unused]] inline std::vector<vector_t> make_random_x0s(const function_t& function, const scalar_t scale = 1.0)
{
    ...
    if (function.name() == "mse+ridge[1e+08][4D]")
    {
        append(0.1510419937298419502, 0.1460285923630579852, -0.0378751317642594953, 0.4140992907610223650);
        append(-0.2278086184026545391, -0.6719146728951743697, 0.7596140441140533106, 0.5938232427077148046);
    }
