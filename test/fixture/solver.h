...
[[maybe_unused]] static auto check_minimize(
    ...
    tensor_size_t max_evals = 50000, scalar_t epsilon = 1e-6, bool expected_convergence = true)
{
    ...
    UTEST_CHECK_EQUAL(state.m_status,
        expected_convergence ? solver_state_t::status::converged : solver_state_t::status::max_iters);
