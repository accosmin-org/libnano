...
std::array<tscalar, 3> make_kernel3x3(kernel3x3_type type)
{
    ...
    case kernel3x3_type::sobel:
        return {static_cast<tscalar>(1) / static_cast<tscalar>(4), static_cast<tscalar>(2) / static_cast<tscalar>(4),
                static_cast<tscalar>(1) / static_cast<tscalar>(4)};

    case kernel3x3_type::scharr:
        return {static_cast<tscalar>(3) / static_cast<tscalar>(16), static_cast<tscalar>(10) / static_cast<tscalar>(16),
                static_cast<tscalar>(3) / static_cast<tscalar>(16)};

    case kernel3x3_type::prewitt:
        return {static_cast<tscalar>(1) / static_cast<tscalar>(3), static_cast<tscalar>(1) / static_cast<tscalar>(3),
                 ...
                 const std::array<tscalar_output, 3> kernel, tensor_map_t<tscalar_output, 2> output)
{
    ...
    const auto make_gg =
        [&](tscalar_input v0, tscalar_input v1, tscalar_input v2, tscalar_input v3, tscalar_input v4, tscalar_input v5)
    {
