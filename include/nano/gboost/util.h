...
namespace nano::gboost
{
    ...
    ///
    NANO_PUBLIC bool done(const tensor2d_t& errors_losses, const indices_t& train_samples,
                          const indices_t& valid_samples, const rwlearners_t& wlearners, scalar_t epsilon,
                          size_t patience, size_t& optimum_round, scalar_t& optimum_value, tensor2d_t& optimum_values);
} // namespace nano::gboost
