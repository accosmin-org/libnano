...
auto stack(const tensor_size_t rows, const tensor_size_t cols, const tblocks&... blocks) -> tensor_mem_t<tscalar, 2U>
requires((is_eigen_v<tblocks> || is_tensor_v<tblocks>) && ...)
{
...
///
template <class tscalar, class... tblocks>
auto stack(const tensor_size_t rows, const tblocks&... blocks) -> tensor_mem_t<tscalar, 1U>
requires((is_eigen_v<tblocks> || is_tensor_v<tblocks>) && ...)
{
